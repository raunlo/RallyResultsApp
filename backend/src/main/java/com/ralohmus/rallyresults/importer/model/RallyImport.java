...
public class RallyImport {
    ...
    private String name;
    private String link;
    private Set<StageImport> stages;

    public RallyImport parseDateString(String dateString) {
    ...
    public RallyImport parseCompetitionNameAndLink(Element element) {
